...
<div class="nav-container navbar-fixed-top">
    ...
    <div class="nav-right fr">
        <span class="nav-hello"><img src="../images/index/user-icon.png" alt="" class="user-icon"/>您好，<s:if test="#request.session.userType == 1">${session.currentUser.username}</s:if><s:else>${session.currentUser.name}</s:else></span>
