...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
      <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="graduate-weekly-report"><span class="glyphicon glyphicon-file" aria-hidden="true"></span>毕业设计</a></li>
            </ul>
 ...
 <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <form action="graduate-weekly-report-add" method="post">
