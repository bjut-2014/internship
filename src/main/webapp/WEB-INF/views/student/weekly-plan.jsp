    ...
    <div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div>标题：<input id="updateTitle" name="updateTitle" type="text" class="form-control plan-title" value=""></div>
				<div>内容：<textarea id="updateContent" name="updateContent" class="form-control plan-content" rows="5" placeholder="1000个字以上"></textarea></div>
